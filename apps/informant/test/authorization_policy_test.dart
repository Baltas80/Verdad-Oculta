...
void main() {
  ...
  test('investigators need explicit approval for correspondence', () {
    expect(
      AuthorizationPolicy.isAllowed(
        const AuthorizationRequest(
          actor: Actor.investigator,
  ...
  test('member entitlement state cannot grant protected evidence access', () {
    expect(
      AuthorizationPolicy.isAllowed(
        const AuthorizationRequest(
          actor: Actor.member,
  ...
  test('system workers cannot publish content', () {
    expect(
      AuthorizationPolicy.isAllowed(
        const AuthorizationRequest(
  ...
  test('members cannot publish or classify archive content', () {
    expect(
      AuthorizationPolicy.isAllowed(
        const AuthorizationRequest(
          actor: Actor.member,
